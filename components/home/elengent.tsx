...
const Elegant = () => {
    ...
    return (
        <section className="relative w-full min-h-screen bg-white flex items-center justify-start py-1 md:py-20 overflow-hidden">
            <div className="w-full relative min-h-[100vh] flex items-center">
                {/* Left Side: Text Reveal */}
                <div className="absolute left-4 md:left-20 z-20 px-[5%] md:pl-[6%] md:pr-[4%] max-w-6xl text-start">
                    <TextScrollReveal
                        text={quote}
                ...
                <div className="absolute z-10 pointer-events-none md:w-[851px] md:h-[976px] md:top-[-150px] right-[-30%] md:-right-[200px] w-[140%] h-[110vh] top-[-5%] opacity-20 scale-[1.5] lg:scale-[1.4] origin-left">
                    <Image
                        src={abstract}
                        alt="Abstract Shape"
                        fill
