    ...
    return (
        <section className="w-full py-24 px-4 md:px-8 lg:px-16">
            <div className="max-w-6xl mx-auto flex flex-col items-center">
                ...
                {/* Heading */}
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-wide text-[#1A1A1A] mb-16 text-center" style={{ fontFamily: 'var(--font-clash-display), sans-serif' }}>
                    GET IN TOUCH
                </h2>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24 w-full">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                        <p className="text-[#6B6B6B] text-base md:text-lg leading-loose mb-10 font-light max-w-lg">
                        ...
                        <button className="px-8 py-3.5 bg-[#5A3F30] hover:bg-[#4A3326] transition-colors duration-300 text-white text-xs tracking-[0.1em] uppercase rounded-full">
                            EXPLORE MORE
                        </button>
                    </div>
