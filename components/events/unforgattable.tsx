...
const Unforgettable = () => {
  return (
    <section className="relative w-full py-20 lg:py-48 bg-[#FCFBF8] overflow-hidden">
      <div className=" px-6 md:px-12 xl:px-24 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full lg:w-[60%] flex flex-col gap-10 z-10">
          <p className="text-[#333333] text-[18px] md:text-[20px] lg:text-[22px] font-normal leading-relaxed font-sans tracking-wide">
        ...
        <div className="w-full lg:w-[60%] h-[400px] lg:h-[120vh] absolute -right-[20%]">
            <motion.div 
